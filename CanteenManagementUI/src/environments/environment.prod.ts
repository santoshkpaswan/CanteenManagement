...
export const environment = {
  ...
  apiLoginUrl: 'http://eshaala.rdias.ac.in:89/API', //development
  _apiLoginUrl:'https://canapi.rdias.ac.in:444/API' // http://eshaala.rdias.ac.in:86/API  Live//https://canapi.rdias.ac.in:444/
};
